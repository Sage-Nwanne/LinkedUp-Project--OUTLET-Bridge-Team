...
export const pipeline = [
  ...
  },
  {
    ...
    n: '06',
    title: 'Belonging',
    subtitle: 'Long-Term Connection',
    accent: 'var(--emerald)',
    summary: 'Belonging is not attendance. It is emotional safety, relationships, and ownership.',
    about:
      'Belonging is the most misunderstood stage in most ministries. It is not the same as attendance. A person can attend for a year and still be unconnected. True belonging is measured in emotional safety, recurring participation, real relationships, ownership of the community, and a sense that "this place is mine." By this stage, the Bridge Team is no longer the primary driver — Connect Group Leaders are. The Bridge Team\u2019s job becomes monitoring health, watching for quiet drop-off, and protecting the environments that produce belonging.',
